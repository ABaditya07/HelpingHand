          ...
          <div className="space-y-6 mt-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-800">adityabhure63@gmail.com</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-800">+91 9322040987</p>
              </div>
            </div>

            {/* Social Media Icons */}
            <div className="flex space-x-6 pt-8 border-t border-black/20">
              {/* LinkedIn */}
              <a
              ...
              {/* GitHub */}
              <a
                href="https://github.com/ABaditya07"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-black p-3 rounded-lg text-white hover:text-gray-400 transition"
              >
                <FaGithub size={28} />
              </a>
            </div>
